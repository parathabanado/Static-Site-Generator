...
class TestSplitDelim(unittest.TestCase):
    def test_no_open_no_close(self):  
    ...
    def test_open_no_close_single(self):  
        node = TextNode("`This is` text with a code block word", TextType.TEXT)
        new_nodes = split_nodes_delimiter([node], "`", TextType.CODE)
        self.assertEqual(new_nodes,[
    ...
    def test_open_no_close_multiple(self):  
        node = TextNode("`This is` text with `a code` block word", TextType.TEXT)
        new_nodes = split_nodes_delimiter([node], "`", TextType.CODE)
        self.assertEqual(new_nodes,[
    TextNode("This is", TextType.CODE),
    ...
    def test_no_open_close_single(self):  
            node = TextNode("This is` text with a code block word`", TextType.TEXT)
            new_nodes = split_nodes_delimiter([node], "`", TextType.CODE)
            self.assertEqual(new_nodes,[
        TextNode("This is", TextType.TEXT),
        TextNode(" text with a code block word", TextType.CODE),
    ])

    def test_no_open_close_multiple(self):  
            node = TextNode("This is` text with `a code` block word`", TextType.TEXT)
            new_nodes = split_nodes_delimiter([node], "`", TextType.CODE)
            self.assertEqual(new_nodes,[
        TextNode("This is", TextType.TEXT),
    ...
    def test_open_close_multiple(self):  
            node = TextNode("`This` is text `with` a code block `word`", TextType.TEXT)
            new_nodes = split_nodes_delimiter([node], "`", TextType.CODE)
            self.assertEqual(new_nodes,[
        ...
        TextNode(" a code block ", TextType.TEXT),
